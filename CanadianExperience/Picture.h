...
public:
    ...
    */
	...
	/** \brief Get a bug drawable object
	* \returns Bug drawable object
	*/
	std::shared_ptr<CBugDrawable> GetBugDrawable() { return mBugDrawable; }

	/** \brief Set the bug drawable
	* \param bug The new bug drawable*/
	void SetBugDrawable(std::shared_ptr<CBugDrawable> bug) { mBugDrawable = bug; }

	/** \brief Get a bug drawable object
	* \returns Bug drawable object
	*/
	std::shared_ptr<CBugDrawable> GetOtherBugDrawable() { return mOtherBugDrawable; }

	/** \brief Set the bug drawable
	* \param bug The new bug drawable*/
	void SetOtherBugDrawable(std::shared_ptr<CBugDrawable> bug) { mOtherBugDrawable = bug; }
...
private:
	...
	/// The bug drawable
	std::shared_ptr<CBugDrawable> mBugDrawable;

	/// The other bug drawable
	std::shared_ptr<CBugDrawable> mOtherBugDrawable;
};
