...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_EDIT_BUGPROPERTIES, &CMainFrame::OnEditBugproperties)
	ON_COMMAND(ID_EDIT_OTHERBUGPROPERTIES, &CMainFrame::OnEditOtherbugproperties)
END_MESSAGE_MAP()
...
void CMainFrame::OnEditBugproperties()
{
	mPicture->GetBugDrawable()->ShowDialogBox();
}


void CMainFrame::OnEditOtherbugproperties()
{
	mPicture->GetOtherBugDrawable()->ShowDialogBox();
}
